  ...
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-8 p-8 text-center">
      ...
      <div className="max-w-md text-xs text-brand-muted">
        ...
        cashier@zadcafe.et, barista@zadcafe.et, kitchen@zadcafe.et, store@zadcafe.et · SaaS: saas@cafeflow.app (password: <code className="rounded bg-brand-surface2 px-1 py-0.5 text-brand-foreground">Yetnora@1</code>)
      </div>
    </main>
  );
}
